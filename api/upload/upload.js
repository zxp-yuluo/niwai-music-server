  ...
  if (image) {
    ...
    ctx.body = {
      ...
      data: {
        ...
        image: {},
        url: 'https://zhuxinpeng.cn/nw/image/' + image.newFilename
  ...
  if (audio) {
    ...
    ctx.body = {
      ...
      data: {
        ...
        audio: {},
        url: 'https://zhuxinpeng.cn/nw/audio/' + audio.newFilename
  ...
  if (lyrics) {
    ctx.body = {
      ...
      data: {
        ...
        lyrics: {},
        url: 'https://zhuxinpeng.cn/nw/lyrics/' + lyrics.newFilename
